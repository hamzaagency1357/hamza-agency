...
-- Supersede the shared-secret gateway without editing the applied migration.
-- It remains present only as a fail-closed compatibility stub and is not
...
revoke all on function public.pr100_server_gateway(text,bigint,text,text,text,text)
  from public, anon, authenticated;

-- The Edge Function verifies Vercel's JWT signature and strict claims first.
-- Only Supabase's managed service_role may enter this database dispatcher.
