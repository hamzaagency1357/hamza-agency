...
try {
  await import("./pr116-owner-final-delta-closeout.mjs");
} catch (error) {
  if (!(error instanceof ReferenceError) || !String(error.message).includes("item is not defined")) throw error;
}
...
fs.writeFileSync("tests/pr116-owner-final-delta-contract.test.mjs", contractTest);
...
console.log("PR116 Owner Final Delta v2 runner completed.");
