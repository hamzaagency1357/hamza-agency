...
const requiredLedgerEvidence = [
  "Last completed code/UX delta Head before this documentation reconciliation: `74c5b8dad339a78f69a43e859a3b6ae89ed78335`",
  "Full Browser Admin mutation boundary",
  "Admin → Public",
  "`+50` فرصة نجاح شهريًا",
  "Navigation Admin → Public truthfulness",
  "Six application statuses",
  "Admin Blog information architecture",
  "Mobile Dock colors",
  "Exact Admin section color mapping",
  "20260810203000_pr116_admin_oidc_boundary_lockdown.sql",
  "READY FOR OWNER FINAL QA",
];
for (const marker of requiredLedgerEvidence) {
  if (!ledger.includes(marker)) throw new Error(`Reconciled ledger evidence missing: ${marker}`);
}
...
console.log("Reconciled PR116 ledger verified and final Owner QA handoff generated.");
