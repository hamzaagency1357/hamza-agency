...
export const PUBLIC_ROUTE_PATHS = ["/","/about","/ai-policy","/ai-support","/apply","/application-status","/contact","/cookie-policy","/digital-services","/faq","/gallery","/jobs","/knowledge-center","/partners","/privacy-policy","/programs","/reviews","/service-request","/service-status","/services","/success-stories","/terms-and-conditions","/track"] as const;
