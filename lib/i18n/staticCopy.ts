...
const staticCopy: Record<SiteLanguage, StaticCopy> = {
  ar: {
    ...
    languageScope: "تتبدل جميع الصفحات العامة والمحتوى والنماذج إلى اللغة المختارة مع بديل آمن عند نقص المحتوى.",
    languageInterface: "واجهة اللغة",
    languageSwitcherLabel: "تبديل لغة الواجهة",
    quickNavTitle: "قائمة الموقع",
    quickNavDescription: "تنقل سريع وواضح بين صفحات الموقع العامة.",
  ...
  en: {
    ...
    partners: "Programs and platforms",
    gallery: "Gallery",
    ...
    languageScope: "All public pages, content, and forms switch to the selected language with a safe fallback for missing content.",
    languageInterface: "Language UI",
    languageSwitcherLabel: "Switch interface language",
    quickNavTitle: "Site menu",
    quickNavDescription: "Fast, clear navigation between public website pages.",
  ...
  tr: {
    ...
    partners: "Programlar ve platformlar",
    gallery: "Galeri",
    ...
    languageScope: "Tüm genel sayfalar, içerikler ve formlar seçilen dile geçer; eksik içerik için güvenli bir alternatif gösterilir.",
    languageInterface: "Dil arayüzü",
    languageSwitcherLabel: "Arayüz dilini değiştir",
    quickNavTitle: "Site menüsü",
    quickNavDescription: "Genel site sayfaları arasında hızlı ve açık gezinme.",
