...
export interface BlogListResult {
  ...
  labels: { title: string; empty: string; noResults: string };
}
...
export interface BlogCategory { slug: string; label: string }
export interface BlogTag { slug: string; label: string }

export function getBlogPosts(options?: BlogPostsOptions): BlogListResult;
export function getBlogPostBySlug(slug: string, options?: { language?: BlogLanguage; preview?: boolean }): BlogPost | null;
...
export function getRelatedBlogPosts(post: BlogPost, options?: { language?: BlogLanguage; preview?: boolean; limit?: number }): BlogPost[];
