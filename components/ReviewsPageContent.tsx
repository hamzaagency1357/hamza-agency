...
const copy = {
  ar: { featuredBadge: "تقييمات مميزة", featuredTitle: "تجارب بارزة", featuredText: "تقييمات مختارة تظهر في مقدمة الصفحة لأنها تمثل تجربة واضحة مع الوكالة أو أحد برامجها.", allBadge: "كل التقييمات", allTitle: "آراء إضافية", allText: "آراء منشورة من صناع المحتوى والعملاء بعد المراجعة.", emptyTitle: "بانتظار أول تقييم منشور", emptyText: "لم يتم نشر تقييمات بعد. يمكنك إرسال تجربتك إلى فريق الوكالة لمراجعتها.", ctaTitle: "لديك تجربة مع وكالة حمزة؟", ctaText: "أرسل رأيك لفريق الوكالة عبر واتساب ليتم مراجعته قبل النشر.", cta: "إرسال تقييم عبر واتساب", reviewer: "عميل وكالة حمزة", unknown: "غير محدد", defaultReview: "تقييم لتجربة التعامل مع وكالة حمزة.", featuredTag: "تقييم مميز" },
  en: { featuredBadge: "Featured reviews", featuredTitle: "Highlighted experiences", featuredText: "Selected reviews appear first because they represent a clear experience with the agency or one of its programs.", allBadge: "All reviews", allTitle: "Additional feedback", allText: "Published creator and client feedback after review.", emptyTitle: "Awaiting the first published review", emptyText: "No reviews have been published yet. You can send your experience to the agency team for review.", ctaTitle: "Have an experience with HAMZA AGENCY?", ctaText: "Send your feedback to the agency team on WhatsApp for review before publication.", cta: "Send feedback on WhatsApp", reviewer: "HAMZA AGENCY client", unknown: "Not specified", defaultReview: "Feedback about the HAMZA AGENCY experience.", featuredTag: "Featured review" },
  tr: { featuredBadge: "Öne çıkan değerlendirmeler", featuredTitle: "Öne çıkan deneyimler", featuredText: "Ajansla veya programlarından biriyle net bir deneyimi yansıttığı için ilk sırada gösterilen seçilmiş değerlendirmeler.", allBadge: "Tüm değerlendirmeler", allTitle: "Ek görüşler", allText: "İncelendikten sonra yayınlanan içerik üreticisi ve müşteri görüşleri.", emptyTitle: "İlk yayınlanmış değerlendirme bekleniyor", emptyText: "Henüz değerlendirme yayınlanmadı. Deneyiminizi incelenmek üzere ajans ekibine gönderebilirsiniz.", ctaTitle: "HAMZA AGENCY ile deneyiminiz var mı?", ctaText: "Görüşünüzü yayın öncesi inceleme için WhatsApp üzerinden ajans ekibine gönderin.", cta: "WhatsApp ile görüş gönder", reviewer: "HAMZA AGENCY müşterisi", unknown: "Belirtilmedi", defaultReview: "HAMZA AGENCY deneyimi hakkında değerlendirme.", featuredTag: "Öne çıkan değerlendirme" },
};
