...
const agentDisplayName: Record<SiteLanguage, string> = { ar: "عراب سوريا", en: "Agent Hamza", tr: "Temsilci Hamza" };
...
function buildAgent(language: SiteLanguage) { return { "@context": "https://schema.org", "@type": "Person", "@id": agentId, name: agentDisplayName[language], alternateName: ["عراب سوريا", "⚔عܓོراب✴سܓོوريا⚔", "Agent Hamza", "Temsilci Hamza"], url: getLocalizedAbsoluteUrl(AGENT_PUBLIC_PATH, language), jobTitle: language === "ar" ? "الوكيل والمدير في HAMZA AGENCY" : language === "tr" ? "Hamza Ajansı Temsilcisi ve Yöneticisi" : "Agent and Manager at HAMZA AGENCY", worksFor: { "@id": organizationId }, knowsAbout: ["Content creator management", "Live-streaming programs", "Creator support", "Privacy and safety"] }; }
