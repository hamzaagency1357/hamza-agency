...
const copy = {
  ar: { back: "← العودة إلى الرئيسية", badge: "تقييمات HAMZA AGENCY", title: "تقييمات وكالة حمزة", accent: "آراء وتجارب العملاء", intro: "هذه الصفحة مخصصة لعرض الآراء المنشورة من صناع المحتوى والعملاء حول التواصل مع وكالة حمزة ومتابعة الطلبات والخدمات.", note: "لا توجد تقييمات منشورة حالياً. تظهر هنا فقط الآراء التي تمت مراجعتها واعتماد نشرها." },
  en: { back: "← Back to home", badge: "HAMZA AGENCY Reviews", title: "HAMZA AGENCY reviews", accent: "Client feedback and experiences", intro: "This page presents published feedback from content creators and clients about contacting HAMZA AGENCY, application follow-up, and services.", note: "There are no published reviews right now. Only reviewed and approved feedback appears here." },
  tr: { back: "← Ana sayfaya dön", badge: "HAMZA AGENCY Değerlendirmeleri", title: "HAMZA AGENCY değerlendirmeleri", accent: "Müşteri görüşleri ve deneyimleri", intro: "Bu sayfa, içerik üreticileri ve müşterilerin HAMZA AGENCY iletişimi, başvuru takibi ve hizmetleri hakkındaki yayınlanmış görüşlerini sunar.", note: "Şu anda yayınlanmış değerlendirme yok. Burada yalnızca incelenmiş ve yayınlanması onaylanmış görüşler görünür." },
};
