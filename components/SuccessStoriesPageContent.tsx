...
const copy = {
  ar: {
    ...
    intro: "نعرض هنا نماذج من مسارات العمل التي تعتمدها وكالة حمزة لدعم صناع المحتوى والعملاء، من التقديم الأول إلى المتابعة والتنظيم واختيار البرنامج المناسب.",
    note: "ملاحظة شفافة: المحتوى الظاهر حالياً يشرح مسارات عمل عامة داخل الوكالة. عند اعتماد قصص منشورة من لوحة الإدارة سيتم عرضها هنا بدلاً من هذه النماذج.",
    ...
    regularText: "نماذج إضافية من طريقة تنظيم الوكالة للتواصل، الطلبات، البرامج، والخدمات الرقمية.",
  ...
  en: {
    ...
    intro: "Here we present examples of the work paths HAMZA AGENCY uses to support content creators and clients, from the first application to follow-up, organization, and choosing the right program.",
    note: "Transparent note: the content currently shown explains general work paths inside the agency. Once published stories are approved through the admin dashboard, they will appear here instead of these examples.",
    ...
    featuredTitle: "Highlighted examples",
    ...
    regularText: "Additional examples of how the agency organizes communication, requests, programs, and digital services.",
  ...
  tr: {
    ...
    intro: "Burada, HAMZA AGENCY'nin içerik üreticilerini ve müşterileri desteklemek için kullandığı çalışma yollarından örnekler sunuyoruz: ilk başvurudan takibe, organizasyona ve doğru programı seçmeye kadar.",
    note: "Şeffaf not: Şu anda gösterilen içerik, ajans içindeki genel çalışma yollarını açıklar. Yönetim paneli üzerinden yayınlanmış hikâyeler onaylandığında bu örneklerin yerine burada gösterilecektir.",
    ...
    featuredTitle: "Öne çıkan örnekler",
    ...
    regularText: "Ajansın iletişim, talepler, programlar ve dijital hizmetleri nasıl düzenlediğine dair ek örnekler.",
  ...
  return (
    <section dir={direction} className="relative z-10 mx-auto max-w-7xl px-5 py-16">
      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        <StatCard title={statLabels[0]} value={`${stories.length}+`} />
