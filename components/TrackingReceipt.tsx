...
const copyByLanguage = {
  ar: {
    eyebrow: "إيصال الرقم المرجعي",
    title: "احتفظ بالرقم المرجعي",
    description: "هذا الرقم هو الطريقة الآمنة لمتابعة الطلب. لا تشاركه علناً.",
    copy: "نسخ الرقم المرجعي",
    copied: "تم النسخ",
    open: "فتح صفحة المتابعة",
    print: "طباعة الإيصال",
  },
  en: {
    eyebrow: "Reference receipt",
    title: "Keep your reference number",
    description: "This number is the secure way to follow up on your request. Do not share it publicly.",
    copy: "Copy reference number",
    copied: "Copied",
    open: "Open follow-up page",
    print: "Print receipt",
  },
  tr: {
    eyebrow: "Referans numarası makbuzu",
    title: "Referans numaranızı saklayın",
    description: "Bu numara talebinizi güvenli biçimde takip etmenizi sağlar. Herkese açık paylaşmayın.",
    copy: "Referans numarasını kopyala",
    copied: "Kopyalandı",
