...
const copy: Record<"ar" | "en" | "tr", JobsCopy> = {
  ar: {
    ...
    validation: { chooseJob: "يرجى اختيار وظيفة أولاً.", fullName: "يرجى كتابة الاسم الكامل.", whatsapp: "يرجى كتابة رقم الواتساب.", databaseUnavailable: "تعذر إرسال الطلب حالياً. يرجى المحاولة مرة أخرى أو التواصل معنا عبر واتساب.", submitError: "حدث خطأ أثناء إرسال طلب الوظيفة. يرجى المحاولة مرة أخرى أو التواصل معنا عبر واتساب.", submitSuccess: "تم استلام طلبك بنجاح. سيقوم فريق وكالة حمزة بمراجعته والتواصل معك عبر واتساب عند الحاجة." },
  ...
  en: {
    ...
    validation: { chooseJob: "Please choose a role first.", fullName: "Please enter your full name.", whatsapp: "Please enter your WhatsApp number.", databaseUnavailable: "We could not send your application right now. Please try again or contact us on WhatsApp.", submitError: "There was an error sending your application. Please try again or contact us on WhatsApp.", submitSuccess: "Your application was received successfully. The HAMZA AGENCY team will review it and contact you on WhatsApp when needed." },
  ...
  tr: {
    ...
    validation: { chooseJob: "Lütfen önce bir pozisyon seçin.", fullName: "Lütfen adınızı ve soyadınızı yazın.", whatsapp: "Lütfen WhatsApp numaranızı yazın.", databaseUnavailable: "Başvurunuz şu anda gönderilemedi. Lütfen tekrar deneyin veya WhatsApp üzerinden bize ulaşın.", submitError: "İş başvurusu gönderilirken bir hata oluştu. Lütfen yeniden deneyin veya WhatsApp üzerinden bizimle iletişime geçin.", submitSuccess: "Başvurunuz başarıyla alındı. HAMZA AGENCY ekibi başvurunuzu inceleyecek ve gerektiğinde WhatsApp üzerinden sizinle iletişime geçecektir." },
