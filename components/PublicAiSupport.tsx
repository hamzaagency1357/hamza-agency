...
export default function PublicAiSupport({open,onOpenChange,mobileDockMode=false,panelId="hamza-ai-support-panel"}:Props={}){
 const pathname=usePathname();const language=useSiteLanguage();const aiCopy=getAiSupportCopy(language);const[internalOpen,setInternalOpen]=useState(false);const controlled=open!==undefined;const isOpen=controlled?open:internalOpen;
