...
const cases = {
  ar: {
    ...
    install: {
      ...
      statusDescription: "استخدم زر «تثبيت التطبيق» لفتح خيار التثبيت في المتصفح.",
  ...
  en: {
    ...
    install: {
      ...
      statusDescription: "Use the “Install app” button to open the browser installation option.",
      button: "Install app",
      back: "Back to home",
    },
  },
