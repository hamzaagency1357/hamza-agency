...
export default function HomePage() {
  ...
  async function submit(event: React.FormEvent) {
    ...
    setTrackingCode("");
    try {
      const result = await submitPublicForm("application", { full_name: form.fullName.trim(), country: form.country.trim(), whatsapp: form.whatsapp.trim(), platform: form.platform, previous_experience: form.previousExperience.trim(), notes: form.notes.trim() }, startedAt, website);
      if (!result.trackingCode) throw new Error("missing_tracking_code");
