...
ملاحظات الأدمن: ${app.internal_notes || "لا يوجد"}
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid w-full max-w-[1400px] grid-cols-1 gap-6 p-4 2xl:grid-cols-[280px_minmax(0,1fr)] 2xl:p-6">
        <aside className="w-full max-w-full overflow-hidden rounded-[2rem] border border-purple-500/20 bg-black/45 p-4 shadow-[0_0_80px_rgba(124,58,237,0.12)] backdrop-blur 2xl:sticky 2xl:top-6 2xl:h-[calc(100vh-48px)]">
          ...
          <nav className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-1">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
