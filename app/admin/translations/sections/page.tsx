...
export default function CmsSectionTranslationsPage() {
  ...
  async function save() {
    ...
    setError("");
    setMessage("");
    const { error: saveError } = await adminBoundaryMutation("pr116_translations_sections_page_entity_content_translations_upsert", { values: rows, filters: [], select: undefined, returnMode: "many", options: {
