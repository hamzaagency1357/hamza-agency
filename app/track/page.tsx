...
export default function TrackPage() {
  ...
  const copy = language === "ar"
    ? { title: "تتبع طلبك", intro: "أدخل الرقم المرجعي الذي استلمته. لا نطلب الاسم أو رقم واتساب للبحث.", label: "الرقم المرجعي", button: "عرض الحالة", notFound: "لم يتم العثور على طلب مطابق.", invalid: "تحقق من الرقم المرجعي وحاول مجدداً.", rate: "محاولات كثيرة. حاول لاحقاً.", state: "الحالة", type: "نوع الطلب", created: "تاريخ الإرسال", updated: "آخر تحديث", back: "الرئيسية", contact: "تواصل معنا" }
    : language === "tr"
      ? { title: "Talebinizi takip edin", intro: "Aldığınız referans numarasını girin. Arama için ad ya da WhatsApp numarası istemeyiz.", label: "Referans numarası", button: "Durumu göster", notFound: "Eşleşen talep bulunamadı.", invalid: "Referans numarasını kontrol edin.", rate: "Çok fazla deneme. Daha sonra tekrar deneyin.", state: "Durum", type: "Talep türü", created: "Gönderim tarihi", updated: "Son güncelleme", back: "Ana sayfa", contact: "İletişim" }
      : { title: "Track your request", intro: "Enter the reference number you received. We never ask for your name or WhatsApp number to search.", label: "Reference number", button: "View status", notFound: "No matching request was found.", invalid: "Check the reference number and try again.", rate: "Too many attempts. Try again later.", state: "Status", type: "Request type", created: "Submitted", updated: "Last update", back: "Home", contact: "Contact" };
